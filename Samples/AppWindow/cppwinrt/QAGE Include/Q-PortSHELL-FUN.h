...
public:
	...
	void Transform_AvatarGetIn(QpoTransform* transform, QpoVec3d* result);

	void Transform_AvatarGetLeft(QpoTransform* transform, QpoVec3d* result);

	void Transform_AvatarGetRight(QpoTransform* transform, QpoVec3d* result);

	void Transform_AvatarGetUp(QpoTransform* transform, QpoVec3d* result);
	...
	bool Collision_Make_DMG_Sphere(QpoVec3d *Center, float f_Radius, float f_Power);

	void Collision_Make_DMG_Mask(VoxelBlock f_OriginBlock, BiVector f_ImpactPoint, BiVector f_ImpactIn, BlockMark f_Begin, BlockMark f_Finish, float f_StepX, float f_StepY, float f_ChangeX, float f_ChangeY, float f_FullEdgePower, float f_PropagationReductionPerc);

	void Collision_Make_DMG_Mask(BiVector f_ImpactCenter, BiVector f_ImpactIn, BlockMark f_Begin, BlockMark f_Finish, float f_StepX, float f_StepY, float f_ChangeX, float f_ChangeY, float f_FullEdgePower, float f_PropagationReductionPerc);

	void Collision_Make_DMG_Blast_Mask(BiVector f_ImpactPoint, float f_FullEdgePower, float f_PropagationReductionPerc, int f_StartExplosionRadius);

	void Collision_Make_Impact(QpoVec3d* Center, QpoVec3d* In, QpoVec3d* DistCenter, float f_Power, float f_ExplosiveForce = 1.0f, float f_HeatPower = WORLD_HEAT_ROOM_TEMP);

	void Collision_Make_Impact_Grid(QpoVec3d* Center, QpoVec3d* In, QpoVec3d* DistCenter, std::shared_ptr<VoxelGrid> f_Grid, BlockMark f_BeginXY, BlockMark f_EndXY, float f_Power, float f_ExplosiveForce = 1.0f, float f_HeatPower = WORLD_HEAT_ROOM_TEMP);

	void Collision_Make_Impact_Grid(BiVector f_Center, BiVector f_In, BiVector f_DistCenter, std::shared_ptr<VoxelGrid> f_Grid, BlockMark f_BeginXY, BlockMark f_EndXY, float f_Power, float f_ExplosiveForce = 1.0f, float f_HeatPower = WORLD_HEAT_ROOM_TEMP);

	void Collision_Make_Impact_Grid_Select(BiVector f_Center, BiVector f_In, BiVector f_DistCenter, BlockMark f_BeginXY, BlockMark f_EndXY, float f_Power, float f_ExplosiveForce = 1.0f, float f_HeatPower = WORLD_HEAT_ROOM_TEMP);
	...
	void Player_World_intersect(void);

	void Avatar_World_intersect(int f_AIflag);
