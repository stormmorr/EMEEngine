/// \file
/// \brief \b Compresses/Decompresses ASCII strings and writes/reads them to BitTransfer class instances.  You can use this to easily serialize and deserialize your own strings.
///
...
#ifndef UN_STRING_COMPRESSOR_H
#define UN_STRING_COMPRESSOR_H
...
/// \brief Writes and reads strings to and from BitTransfer
///
...
class RAK_DLL_EXPORT unStringCompressor
{
public:
	...
	/// \return the unique instance of the unStringCompressor 
	static unStringCompressor* Instance(void);
	...
	/// \param[out] output The BitTransfer to write the compressed string to
	...
	/// \param[in] input The BitTransfer containing the compressed string
	/// \param[in] languageID Which language to use
...
private:
	...
	/// Singleton instance
	static unStringCompressor *instance;
...
/// The RakPeer constructor adds a reference to this class, so don't call this until an instance of RakPeer exists, or unless you call AddReference yourself.
#define g_unStringCompressor unStringCompressor::Instance()
