...
bool QunCoreTrack::addCoreKeyframe(QunCoreKeyframe *pCoreKeyframe)
{
...
bool QunCoreTrack::getState(float time, QunVector& translation, QunQuaternion& rotation)
{
  std::vector<QunCoreKeyframe*>::iterator iteratorCoreKeyframeBefore;
  std::vector<QunCoreKeyframe*>::iterator iteratorCoreKeyframeAfter;
  ...
  QunCoreKeyframe *pCoreKeyframeBefore;
  pCoreKeyframeBefore = *iteratorCoreKeyframeBefore;
  QunCoreKeyframe *pCoreKeyframeAfter;
...
std::vector<QunCoreKeyframe*>::iterator QunCoreTrack::getUpperBound(float time)
{
...
bool QunCoreTrack::setCoreBoneId(int coreBoneId)
{
  if(coreBoneId < 0)
  {
...
int QunCoreTrack::getCoreKeyframeCount()
{
  return m_keyframes.size();
}


QunCoreKeyframe* QunCoreTrack::getCoreKeyframe(int idx)
{
...
void QunCoreTrack::scale(float factor)
{
  for(size_t keyframeId = 0; keyframeId < m_keyframes.size(); keyframeId++)
  {
    QunVector translation = m_keyframes[keyframeId]->getTranslation();
    translation*=factor;
