...
std::vector<QunCoreSubMorphTarget::BlendVertex>& QunCoreSubMorphTarget::getVectorBlendVertex()
{
...
int QunCoreSubMorphTarget::getBlendVertexCount() const
{
...
void	QunCoreSubMorphTarget::setCoreSubmesh( QunCoreSubmesh* inCoreSubmesh )
{
...
QunCoreSubmesh*		QunCoreSubMorphTarget::getCoreSubmesh() const
{
...
bool QunCoreSubMorphTarget::reserve(int blendVertexCount)
{
	bool	success = true;
	try
	{
...
bool QunCoreSubMorphTarget::setBlendVertex(int blendVertexId, const BlendVertex& blendVertex)
{
...
void	QunCoreSubMorphTarget::getBlendVertex( int vertexId, BlendVertex& outVertex ) const
{
...
bool QunSharedDifferenceMap::reserve(int blendVertexCount)
{
	bool	success = true;
	try
	{
...
bool QunSharedDifferenceMap::appendBlendVertex(int vertexID,
	const QunCoreSubMorphTarget::BlendVertex& vertex)
{
...
bool	QunSharedDifferenceMap::getBlendVertex( int vertexId,
									QunCoreSubMorphTarget::BlendVertex& outVertex ) const
{
...
QunCoreSubMorphTargetDiffMap::QunCoreSubMorphTargetDiffMap()
	: m_diffMap( new QunSharedDifferenceMap )
{
}

QunCoreSubMorphTargetDiffMap::QunCoreSubMorphTargetDiffMap( const QunCoreSubMorphTargetDiffMap& inOther )
...
bool QunCoreSubMorphTargetDiffMap::reserve(int blendVertexCount)
{
	return m_diffMap->reserve( blendVertexCount ) &&
		QunCoreSubMorphTarget::reserve( blendVertexCount );
}
...
void	QunCoreSubMorphTargetDiffMap::setCoreSubmesh( QunCoreSubmesh* inCoreSubmesh )
{
	QunCoreSubMorphTarget::setCoreSubmesh( inCoreSubmesh );
	
	// Cache the blend vertices computed from the core vertices and the
	// difference map.
	const std::vector<QunCoreSubmesh::Vertex>&	coreVerts(
		inCoreSubmesh->getVectorVertex() );
	const unsigned int kNumVerts = coreVerts.size();
	QunCoreSubMorphTarget::reserve( kNumVerts );
...
bool QunCoreSubMorphTargetDiffMap::appendBlendVertex(int vertexId,
	const QunCoreSubMorphTarget::BlendVertex& vertex)
{
