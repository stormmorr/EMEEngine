...
/** Copying a Matrix
  ...
  *****************************************************************************/
/*
void QunMatrix::operator =(const QunMatrix& m)
{
...
QunMatrix::QunMatrix(const QunQuaternion& q)
{
  *this = q;
}
...
void QunMatrix::operator =(const QunQuaternion& q)
{
  float xx2=q.x*q.x*2;
  float yy2=q.y*q.y*2;
  float zz2=q.z*q.z*2;
...
/** Matrix Initialization
  ...
  *****************************************************************************/
/*
QunMatrix::QunMatrix(float factor, const QunMatrix& m)
{
  dxdx = m.dxdx*factor;
  dxdy = m.dxdy*factor;
  dxdz = m.dxdz*factor;
...
/** Matrix Blending
  ...
  *****************************************************************************/
/*
void QunMatrix::blend(float factor, const QunMatrix& m)
{
  dxdx += m.dxdx*factor;
  dxdy += m.dxdy*factor;
  dxdz += m.dxdz*factor;
...
/** Matrix Scaling
  ...
  *****************************************************************************/
/*
void QunMatrix::operator *=(float factor)
{
  dxdx *= factor;
  dxdy *= factor;
  dxdz *= factor;
