...
#include "pch.h" // Copyright (C) 2003 Steven Geens                                            //
//****************************************************************************//
...
bool QunCoreMorphAnimation::addMorphTarget(int coreMeshID,int morphTargetID)
{
...
std::vector<int>& QunCoreMorphAnimation::getVectorCoreMeshID()
{
...
std::vector<int>& QunCoreMorphAnimation::getVectorMorphTargetID()
{
  return m_vectorMorphTargetID;
}


const std::string& QunCoreMorphAnimation::getName() const
{
	return m_name;
}

void QunCoreMorphAnimation::setName( const std::string& name )
{
	m_name = name;
}
