...
/** Constructs the quaternion instance.
  ...
  *****************************************************************************/
/*
QunQuaternion::QunQuaternion(const QunQuaternion& q)
...
/** Constructs the quaternion instance.
  ...
  *****************************************************************************/
/*
QunQuaternion::QunQuaternion(float qx, float qy, float qz, float qw)
  : x(qx), y(qy), z(qz), w(qw)
{
}
*/
...
/** Provides access to the components of the quaternion instance.
  ...
  *****************************************************************************/
/*
float& QunQuaternion::operator[](unsigned int index)
{
  return (&x)[index];
}
*/
...
/** Provides access to the components of the quaternion instance.
  ...
  *****************************************************************************/
/*
const float& QunQuaternion::operator[](unsigned int index) const
{
  return (&x)[index];
}
*/
...
/** Equates the quaternion instance with another quaternion.
  ...
  *****************************************************************************/
/*
void QunQuaternion::operator=(const QunQuaternion& q)
{
  x = q.x;
  y = q.y;
  z = q.z;
...
/** Multiplies a vector to the quaternion instance.
  ...
  *****************************************************************************/
/*
void QunQuaternion::operator*=(const QunVector& v)
{
  float qx, qy, qz, qw;
  qx = x;
  qy = y;
...
*/
 /*****************************************************************************/
/** Qunculates the product of two quaternions.
  *
  ...
  *****************************************************************************/
/*
QunQuaternion operator*(const QunQuaternion& q, const QunQuaternion& r)
{
...
/** Interpolates the quaternion instance to another quaternion.
  ...
  *****************************************************************************/
/*
void QunQuaternion::blend(float d, const QunQuaternion& q)
{
  float norm;
...
/** Sets new values.
  ...
  *****************************************************************************/
/*
void QunQuaternion::set(float qx, float qy, float qz, float qw)
{
  x = qx;
  y = qy;
  z = qz;
...
/** Computes the shortest arc quaternion that will rotate one vector to another.
  ...
  *****************************************************************************/
/*
QunQuaternion shortestArc( const QunVector& from, const QunVector& to )
{
...
void QunQuaternion::compress(short &s0, short &s1, short &s2)
{
...
void QunQuaternion::decompress(short &s0, short &s1, short &s2)
{
