...
QunCoreKeyframe::QunCoreKeyframe()
  : m_time(0.0f)
{
}
...
const QunQuaternion& QunCoreKeyframe::getRotation()
{
  return m_rotation;
}
...
const QunVector& QunCoreKeyframe::getTranslation()
{
...
void QunCoreKeyframe::setRotation(const QunQuaternion& rotation)
{
  m_rotation = rotation;
}
...
void QunCoreKeyframe::setTime(float time)
{
  m_time = time;
}
...
void QunCoreKeyframe::setTranslation(const QunVector& translation)
{
