...
QunAnimationAction::QunAnimationAction(QunCoreAnimation* pCoreAnimation)
...
bool QunAnimationAction::execute(float delayIn, float delayOut, float weightTarget,bool autoLock)
{
  setState(STATE_IN);
  setWeight(0.0f);
  m_delayIn = delayIn;
...
bool QunAnimationAction::update(float deltaTime)
{
