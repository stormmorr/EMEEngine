...
namespace
{
    QunError::Code m_lastErrorCode = QunError::OK;
...
QunError::Code QunError::getLastErrorCode()
{
...
std::string QunError::getErrorDescription(Code code)
{
  switch(code)
  {
    ...
    case INVALID_MIXER_TYPE:         return "The QunModel mixer is not a QunMixer instance";
...
const std::string& QunError::getLastErrorFile()
{
...
const std::string& QunError::getLastErrorText()
{
...
void QunError::setLastError(Code code, const std::string& strFile, int line, const std::string& strText)
{
