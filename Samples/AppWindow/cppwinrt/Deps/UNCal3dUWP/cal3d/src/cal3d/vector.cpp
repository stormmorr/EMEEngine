...
/** Constructs the vector instance.
  ...
  *****************************************************************************/
/*
QunVector::QunVector(const QunVector& v)
  : x(v.x), y(v.y), z(v.z)
{
}
*/
...
/** Constructs the vector instance.
  ...
  *****************************************************************************/
/*
QunVector::QunVector(float vx, float vy, float vz)
  : x(vx), y(vy), z(vz)
{
}
*/
...
/** Provides access to the components of the vector instance.
  ...
  *****************************************************************************/
/*
float& QunVector::operator[](unsigned int i)
{
  return (&x)[i];
}
*/
...
/** Provides access to the components of the vector instance.
  ...
  *****************************************************************************/
/*
const float& QunVector::operator[](unsigned int i) const
{
  return (&x)[i];
}
*/
...
/** Equates the vector instance with another vector.
  ...
  *****************************************************************************/
/*
void QunVector::operator=(const QunVector& v)
{
  x = v.x;
  y = v.y;
  z = v.z;
...
/** Scales the vector instance.
  ...
  *****************************************************************************/
/*
void QunVector::operator*=(const float d)
{
  x *= d;
  y *= d;
  z *= d;
...
void QunVector::operator*=(const QunQuaternion& q)
{
  QunQuaternion temp(-q.x, -q.y, -q.z, q.w);
  temp *= *this;
  temp *= q;
...
/** Transforms the vector instance by a matrix.
  ...
  *****************************************************************************/
/*
void QunVector::operator*=(const QunMatrix& m)
{
  float ox = x;
  float oy = y;
  float oz = z;
...
/** Tests the equality of 2 vectors
  ...
  *****************************************************************************/
/*
bool QunVector::operator==(const QunVector& v)
{
  return ((x == v.x) && (y == v.y) && (z == v.z));
}
*/
 /*****************************************************************************/
/** Qunculates the sum of two vectors.
  *
  ...
  *****************************************************************************/
/*
QunVector operator+(const QunVector& v, const QunVector& u)
{
  return QunVector(v.x + u.x, v.y + u.y, v.z + u.z);
}
*/
 /*****************************************************************************/
/** Qunculates the difference of two vectors.
  *
...
/** Qunculates a scaled vector.
  ...
  *****************************************************************************/
/*
QunVector operator*(const QunVector& v, float d)
{
...
/** Qunculates a scaled vector.
  ...
  *****************************************************************************/
/*
QunVector operator*(float d, const QunVector& v)
{
  return QunVector(v.x * d, v.y * d, v.z * d);
}
*/
...
*/
 /*****************************************************************************/
/** Qunculates the dot product of two vectors.
  *
  ...
  *****************************************************************************/
/*
float operator*(const QunVector& v, const QunVector& u)
{
  return v.x * u.x + v.y * u.y + v.z * u.z;
}
*/
 /*****************************************************************************/
/** Qunculates the vector product of two vectors.
  *
...
/** Interpolates the vector instance to another vector.
  ...
  *****************************************************************************/
/*
void QunVector::blend(float d, const QunVector& v)
{
  x += d * (v.x - x);
  y += d * (v.y - y);
  z += d * (v.z - z);
...
/** Sets new values.
  ...
  *****************************************************************************/
/*
void QunVector::set(float vx, float vy, float vz)
{
  x = vx;
  y = vy;
  z = vz;
...
float QunPlane::eval(const QunVector &p)
{
   return p.x*a+p.y*b+p.z*c+d;
}

void QunPlane::setPosition(const QunVector &p)
{
   d=-p.x*a-p.y*b-p.z*c;
}

void QunPlane::setNormal(QunVector &p)
{
     a=p.x;
     b=p.y;
     c=p.z;
...
float QunPlane::dist(QunVector &p)
{
...
/** Computes points of a bounding box.
  ...
  *
  * @param p A pointer to QunVector[8], the 8 points of the bounding box
  *****************************************************************************/


void QunBoundingBox::computePoints(QunVector *p)
{
    QunMatrix m;
