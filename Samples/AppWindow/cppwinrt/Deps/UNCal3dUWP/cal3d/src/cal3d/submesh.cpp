...
QunSubmesh::QunSubmesh(QunCoreSubmesh* coreSubmesh)
{
  assert(coreSubmesh);
  ...
  if(m_pCoreSubmesh->getSpringCount() > 0)
  {
    ...
    std::vector<QunCoreSubmesh::Vertex>& vectorVertex = m_pCoreSubmesh->getVectorVertex();
...
int QunSubmesh::getCoreMaterialId() const
{
...
QunCoreSubmesh *QunSubmesh::getCoreSubmesh()
{
...
int QunSubmesh::getFaceCount() const
{
  return m_faceCount;
}
...
/** Provides access to the face data.
  ...
  *****************************************************************************/
int QunSubmesh::getFaces(QunIndex *pFaceBuffer)
{
...
std::vector<QunVector>& QunSubmesh::getVectorNormal()
{
...
std::vector<std::vector<QunSubmesh::TangentSpace> >& QunSubmesh::getVectorVectorTangentSpace()
{
...
std::vector<QunSubmesh::PhysicalProperty>& QunSubmesh::getVectorPhysicalProperty()
{
...
std::vector<QunVector>& QunSubmesh::getVectorVertex()
{
  return m_vectorVertex;
}

std::vector<QunVector>& QunSubmesh::getVectorVertexn()
{
  return m_vectorVertex;
}

std::vector<QunSubmesh::Face>& QunSubmesh::getVectorFace()
{
  return m_vectorFace;
}
...
int QunSubmesh::getVertexCount() const
{
...
bool QunSubmesh::hasInternalData() const
{
...
void QunSubmesh::disableInternalData()
{
  if(m_bInternalData)
  {
...
bool QunSubmesh::isTangentsEnabled(int mapId) const
{
...
bool QunSubmesh::enableTangents(int mapId, bool enabled)
{
  ...
  std::vector<QunCoreSubmesh::TangentSpace >& vectorTangentSpace = m_pCoreSubmesh->getVectorVectorTangentSpace()[mapId];
...
void QunSubmesh::setCoreMaterialId(int coreMaterialId)
{
...
void QunSubmesh::setLodLevel(float lodLevel)
{
  ...
  const QunCoreSubmesh::Vertex*	coreVertexPtr = &vectorVertex[0];

  // calculate the new number of vertices
  m_vertexCount = coreVertexCount - lodCount;

  // get face vector of the core submesh
  std::vector<QunCoreSubmesh::Face>& vectorFace = m_pCoreSubmesh->getVectorFace();
  const QunCoreSubmesh::Face* coreFacePtr = &vectorFace[0];
...
void QunSubmesh::setMorphTargetWeight(int blendId,float weight)
{
...
float QunSubmesh::getMorphTargetWeight(int blendId) const
{
...
float QunSubmesh::getBaseWeight() const
{
...
/** Returns the morph target weight vector.
  ...
  *****************************************************************************/
std::vector<float>& QunSubmesh::getVectorMorphTargetWeight()
{
...
int QunSubmesh::getMorphTargetWeightCount() const
{
