...
QunAnimationCycle::QunAnimationCycle(QunCoreAnimation* pCoreAnimation)
: QunAnimation(pCoreAnimation)
{
  setType(TYPE_CYCLE);
  setState(STATE_SYNC);
...
bool QunAnimationCycle::blend(float weight, float delay)
{
...
void QunAnimationCycle::setAsync(float time, float duration)
{
...
bool QunAnimationCycle::update(float deltaTime)
{
