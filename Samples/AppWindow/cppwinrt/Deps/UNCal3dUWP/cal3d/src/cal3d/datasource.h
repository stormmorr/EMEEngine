...
/**
 * QunDataSource abstract interface class.
 *
 * This is an abstract class designed to represent a source of Qun3d data,
 * whether it is an ifstream, istream, or even a memory buffer. Inheriting
 * classes must implement the 'read' functions below.
 */

class CAL3D_API QunDataSource
{
public:
