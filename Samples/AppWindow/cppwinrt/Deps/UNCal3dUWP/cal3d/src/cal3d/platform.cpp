...
bool QunPlatform::readBytes(std::istream& input, void *pBuffer, int length)
{
...
bool QunPlatform::readFloat(std::istream& input, float& value)
{
...
bool QunPlatform::readShort(std::istream& input, short& value)
{
...
bool QunPlatform::readInteger(std::istream& input, int& value)
{
  input.read((char *)&value, 4);
...
bool QunPlatform::readString(std::istream& input, std::string& strValue)
{
...
bool QunPlatform::readBytes(char* input, void *pBuffer, int length)
{
...
bool QunPlatform::readFloat(char* input, float& value)
{
...
bool QunPlatform::readShort(char* input, short& value)
{
  if (input == NULL) return false;
...
bool QunPlatform::readInteger(char* input, int& value)
{
  if (input == NULL) return false;
...
bool QunPlatform::readString(char* input, std::string& strValue)
{
  if (input == NULL) return false;
...
bool QunPlatform::writeBytes(std::ostream& output, const void *pBuffer, int length)
{
...
bool QunPlatform::writeFloat(std::ostream& output, float value)
{
...
bool QunPlatform::writeShort(std::ostream& output, short value)
{
...
bool QunPlatform::writeInteger(std::ostream& output, int value)
{
...
bool QunPlatform::writeString(std::ostream& output, const std::string& strValue)
{
  // get the string length
  int length;
