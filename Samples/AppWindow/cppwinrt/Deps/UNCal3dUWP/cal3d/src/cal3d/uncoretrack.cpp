...
bool UN_CoreTrack::addCoreKeyframe(CalCoreKeyframe pCoreKeyframe)
{
...
bool UN_CoreTrack::getState(float time, CalVector& translation, CalQuaternion& rotation)
{
  ip::vector<CalCoreKeyframe, Alloc_KeyFrame>::iterator iteratorCoreKeyframeBefore;
  ip::vector<CalCoreKeyframe, Alloc_KeyFrame>::iterator iteratorCoreKeyframeAfter;
...
ip::vector<CalCoreKeyframe, Alloc_KeyFrame>::iterator UN_CoreTrack::getUpperBound(float time)
{
...
bool UN_CoreTrack::setCoreBoneId(int coreBoneId)
{
  if(coreBoneId < 0)
  {
...
int UN_CoreTrack::getCoreKeyframeCount()
{
  return (*m_keyframes).size();
}


CalCoreKeyframe *UN_CoreTrack::getCoreKeyframe(int idx)
{
...
void UN_CoreTrack::scale(float factor)
{
