...
QunMesh::QunMesh(QunCoreMesh* pCoreMesh)
  : m_pModel(0)
  , m_pCoreMesh(0)
{
  assert(pCoreMesh);
  ...
  {
    m_vectorSubmesh.push_back(new(std::nothrow) QunSubmesh(vectorCoreSubmesh[submeshId]));
  }
}
...
QunCoreMesh *QunMesh::getCoreMesh()
{
  return m_pCoreMesh;
}
...
QunSubmesh *QunMesh::getSubmesh(int id)
{
...
int QunMesh::getSubmeshCount() const
{
...
std::vector<QunSubmesh *>& QunMesh::getVectorSubmesh()
{
...
void QunMesh::setLodLevel(float lodLevel)
{
...
void QunMesh::setMaterialSet(int setId)
{
...
void QunMesh::setModel(QunModel *pModel)
{
  m_pModel = pModel;
}
...
void QunMesh::disableInternalData()
{
