...
namespace winrt::SDKTemplate::implementation
{
	...
	public:
		...
		bool m_Render_ThreadON;
		bool m_Engine_ThreadON;
		bool m_Interface_ThreadON;
		bool m_InputUp_ThreadON;
		bool m_Frame_ThreadON;

		bool m_Render_ThreadON_Still;
		bool m_Engine_ThreadON_Still;
		...
		fire_and_forget OnClickOpenGrid(void);
		...
		void acInputUpLoop(winrt::Windows::Foundation::IInspectable const& sender, winrt::Windows::Foundation::IInspectable e);
		...
		std::shared_mutex m_OGL_Muti;

		int m_Current_ThreadID;
#endif
		...
		winrt::Windows::UI::Xaml::DispatcherTimer m_InputUpTimer;
		...
		void StartInterfaceLoop(void);
		void StartInputUpLoop(void);
		void StartFrameLoop(void);
		void StartEditorRenderLoop(void);
		...
		void EngineLoopManager(void);
		void EngineFrame(void);

		void StopRenderLoop();
		void StopInterfaceLoop();
		void StopInputUpLoop();
		void StopFrameLoop();
		void StopEngineLoop();

		void OnSwapKeyDown(winrt::Windows::Foundation::IInspectable const& sender, winrt::Windows::UI::Core::KeyEventArgs const& e);
		void OnSwapKeyUp(winrt::Windows::Foundation::IInspectable const& sender, winrt::Windows::UI::Core::KeyEventArgs const& e);

		winrt::Windows::UI::Xaml::Controls::TextBlock ac_Acquire_QINT(int f_Index);

		bool m_PlayerTeamsInvalid;
		...
		void OnClickCentralClose(winrt::Windows::Foundation::IInspectable const& sender, winrt::Windows::UI::Xaml::RoutedEventArgs const& e);
		void OnClickLoginClose(winrt::Windows::Foundation::IInspectable const& sender, winrt::Windows::UI::Xaml::RoutedEventArgs const& e);
		void OnClickCreateAngel(winrt::Windows::Foundation::IInspectable const& sender, winrt::Windows::UI::Xaml::RoutedEventArgs const& e);
		void OnClickExploreAngels(winrt::Windows::Foundation::IInspectable const& sender, winrt::Windows::UI::Xaml::RoutedEventArgs const& e);
		void OnClickViewStats(winrt::Windows::Foundation::IInspectable const& sender, winrt::Windows::UI::Xaml::RoutedEventArgs const& e);
		void OnClickTradableLicenses(winrt::Windows::Foundation::IInspectable const& sender, winrt::Windows::UI::Xaml::RoutedEventArgs const& e);
		void OnClickItemBank(winrt::Windows::Foundation::IInspectable const& sender, winrt::Windows::UI::Xaml::RoutedEventArgs const& e);
		void OnClickAngelTrade(winrt::Windows::Foundation::IInspectable const& sender, winrt::Windows::UI::Xaml::RoutedEventArgs const& e);
...
extern winrt::Windows::UI::WindowManagement::AppWindow appWindowOgl;