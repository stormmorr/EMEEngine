...
HRESULT VSDCTShadowMap::RestoreDeviceObjects()
{
    ...
    HRESULT hr = D3DXCreateEffectFromFile(m_pd3dDevice, "programs\\PracticalCubeShadowMaps\\VSDCT.fx",
...
bool VSDCTShadowMap::InvalidateDeviceObjects()
{
    return true;
}
...
HRESULT VSDCTShadowMap::Clear(float Z)
{
    m_fClearZ = Z;
