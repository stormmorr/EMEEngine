...
#ifndef unPhosectOcTree_H
#define unPhosectOcTree_H
...
*/
class unPhosectOcTree
{
	public:
		unPhosectOcTreeNode *root;	//!< root node for octree
		...
		*/
		...
		void clip_ray(const pVector& ro,const pVector& rd,pArray<unPhosectOcTreeNode *>& nodes) const;
		...
		*/
		...
		void clip_frustum(const pFrustum& view,pArray<unPhosectOcTreeNode *>& nodes) const;
		...
		*/
		...
		void sort_nodes(unPhosectOcTreeNode **n,int num) const;
};
