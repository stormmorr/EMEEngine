...
#ifndef PHOSECTNUCLEUS_H
#define PHOSECTNUCLEUS_H
...
class unPhosectNucleus : public unClarity , public CThread
{
public:

	UINT Start(LPVOID lpParam);

	unPhosectNucleus(void* pOwnerObject = NULL, icThreadData *pData = 0);
	virtual ~unPhosectNucleus();

	bool acSplitContext(void);
	...
	static unPhosectNucleus* instance();
...
private:
	static unPhosectNucleus* s_instance;
