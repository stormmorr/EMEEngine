...
#pragma message("Server Engine Excludes")
		...
		if(sizeof(CalIndex)==2) glDrawElements(GL_TRIANGLES, m_calHardwareModel->getFaceCount() * 3, GL_UNSIGNED_SHORT, (((CalIndex *)NULL)+ m_calHardwareModel->getStartIndex()));
		else glDrawElements(GL_TRIANGLES, m_calHardwareModel->getFaceCount() * 3, GL_UNSIGNED_INT, (((CalIndex *)NULL)+ m_calHardwareModel->getStartIndex()));
		}
...
{
	m_calModel->getMixer()->BlendAnim(i_Motion, i_Time, i_BlendAmount);
}

void unAvatar::BlendAnimMin(int i_Motion, float i_Time, float i_BlendAmount)
{
	m_calModel->getMixer()->BlendAnimMin(i_Motion, i_Time, i_BlendAmount);
}

void unAvatar::BlendAnimTorque(int i_Motion, float i_Time, float i_BlendAmount)
{
	m_calModel->getMixer()->BlendAnimTorque(i_Motion, i_Time, i_BlendAmount, 1);
}
...
void unAvatar::BlendAnimPhysics(int i_Motion, float i_Time, float i_BlendAmount) 
{
	...
	if(m_BoneStructure != -1)
		...
		pSkeleton = m_calModel->getSkeleton();
		...
		if(m_BoneStructure == 0)
			{
			PxMat33 i_avatarmatrix(PxVec3(playerAV->Viewform.m[0][0], playerAV->Viewform.m[1][0], playerAV->Viewform.m[2][0]), PxVec3(playerAV->Viewform.m[0][1], playerAV->Viewform.m[1][1], playerAV->Viewform.m[2][1]), PxVec3(playerAV->Viewform.m[0][2], playerAV->Viewform.m[1][2], playerAV->Viewform.m[2][2]));
			Digi::DigiMassCore::instance()->acBoneStructurePose(m_BoneStructure, vectorBone, i_avatarmatrix, PxVec3(playerAV->Xform.Translation.x, playerAV->Xform.Translation.y, playerAV->Xform.Translation.z));
			}
		else
			{
...
void unAvatar::BlendAnimPhysicsSurgery(int i_Motion, float i_Time, float i_BlendAmount) 
{
	...
	if(m_BoneStructure != -1)
		...
		if(m_BoneStructure == 0)
			{
			PxMat33 i_avatarmatrix(PxVec3(playerAV->Viewform.m[0][0], playerAV->Viewform.m[1][0], playerAV->Viewform.m[2][0]), PxVec3(playerAV->Viewform.m[0][1], playerAV->Viewform.m[1][1], playerAV->Viewform.m[2][1]), PxVec3(playerAV->Viewform.m[0][2], playerAV->Viewform.m[1][2], playerAV->Viewform.m[2][2]));
			Digi::DigiMassCore::instance()->acBoneStructurePoseSurgery(m_BoneStructure, vectorBone, i_avatarmatrix, PxVec3(playerAV->Xform.Translation.x, playerAV->Xform.Translation.y, playerAV->Xform.Translation.z));
			}
		else
			{
			PxMat33 i_avatarmatrix(PxVec3(Q_Forge->Forge[m_BoneStructure-1].AV.Xform.Matrix.m[0][0], Q_Forge->Forge[m_BoneStructure-1].AV.Xform.Matrix.m[1][0], Q_Forge->Forge[m_BoneStructure-1].AV.Xform.Matrix.m[2][0]), PxVec3(Q_Forge->Forge[m_BoneStructure-1].AV.Xform.Matrix.m[0][1], Q_Forge->Forge[m_BoneStructure-1].AV.Xform.Matrix.m[1][1], Q_Forge->Forge[0].AV.Xform.Matrix.m[2][1]), PxVec3(Q_Forge->Forge[m_BoneStructure-1].AV.Xform.Matrix.m[0][2], Q_Forge->Forge[m_BoneStructure-1].AV.Xform.Matrix.m[1][2], Q_Forge->Forge[m_BoneStructure-1].AV.Xform.Matrix.m[2][2]));
...
void unAvatar::BlendAnimPhysicsProp(int i_Motion, float i_Time, float i_BlendAmount) 
{
	...
	if(m_BoneStructure != -1)
		...
		if(m_BoneStructure == 0)
			{
			PxMat33 i_avatarmatrix(PxVec3(playerAV->Viewform.m[0][0], playerAV->Viewform.m[1][0], playerAV->Viewform.m[2][0]), PxVec3(playerAV->Viewform.m[0][1], playerAV->Viewform.m[1][1], playerAV->Viewform.m[2][1]), PxVec3(playerAV->Viewform.m[0][2], playerAV->Viewform.m[1][2], playerAV->Viewform.m[2][2]));
			Digi::DigiMassCore::instance()->acBoneStructurePoseProp(m_BoneStructure, vectorBone, i_avatarmatrix, PxVec3(playerAV->Xform.Translation.x, playerAV->Xform.Translation.y, playerAV->Xform.Translation.z));
			}
		else
			{
			PxMat33 i_avatarmatrix(PxVec3(Q_Forge->Forge[m_BoneStructure-1].AV.Xform.Matrix.m[0][0], Q_Forge->Forge[m_BoneStructure-1].AV.Xform.Matrix.m[1][0], Q_Forge->Forge[m_BoneStructure-1].AV.Xform.Matrix.m[2][0]), PxVec3(Q_Forge->Forge[m_BoneStructure-1].AV.Xform.Matrix.m[0][1], Q_Forge->Forge[m_BoneStructure-1].AV.Xform.Matrix.m[1][1], Q_Forge->Forge[0].AV.Xform.Matrix.m[2][1]), PxVec3(Q_Forge->Forge[m_BoneStructure-1].AV.Xform.Matrix.m[0][2], Q_Forge->Forge[m_BoneStructure-1].AV.Xform.Matrix.m[1][2], Q_Forge->Forge[m_BoneStructure-1].AV.Xform.Matrix.m[2][2]));
...
#if defined(ENABLE_NX_PHYSICS)
CalQuaternion CompResult(PxMat33 i_Matrix, PxMat33 i_AvatarMatrix)
{
#if 0
	PxMat33 i_TransferMatrix, invAvatarMatrix;
	PxVec3 i_Row0, i_Row1, i_Row2;
	PxQuat i_Quat;
	CalQuaternion i_CalQuat;
...
void unAvatar::acSetPose(void)
{
	...
	CalQuaternion rotation, i_TransferQuat;
	CalBone *pBone;
...
#pragma message("Solve: consider AI avatars in flight and change matrix to full rotation equivelant - Search pattern - if(Q_Forge->Forge[i].AirJinkRotFG == 1)")
	...
	i_BoneMatrix = i_BoneMatrixTransfer41; i_BoneMatrix = i_avatarinverse * i_BoneMatrix;

#if 0
	cal_vec3d = Digi::DigiMassCore::instance()->getBoneheadPosition(m_BoneStructure);

	cal_vec3d.x -= playerAV->Xform.Translation.x;
	cal_vec3d.y -= playerAV->Xform.Translation.y;
	cal_vec3d.z -= playerAV->Xform.Translation.z;
#endif
	...
	i_BoneMatrix[0][0] = i_Row0.x;
	i_BoneMatrix[1][0] = i_Row0.y;
	i_BoneMatrix[2][0] = i_Row0.z;
	i_BoneMatrix[0][1] = i_Row1.x;
	i_BoneMatrix[1][1] = i_Row1.y;
	i_BoneMatrix[2][1] = i_Row1.z;
	i_BoneMatrix[0][2] = i_Row2.x;
	i_BoneMatrix[1][2] = i_Row2.y;
	i_BoneMatrix[2][2] = i_Row2.z;

	i_BoneMatrix[0][0] = i_Row0.x;
	i_BoneMatrix[1][0] = i_Row1.y;
	i_BoneMatrix[2][0] = i_Row2.z;
	i_BoneMatrix[0][1] = i_Row0.x;
	i_BoneMatrix[1][1] = i_Row1.y;
	i_BoneMatrix[2][1] = i_Row2.z;
	i_BoneMatrix[0][2] = i_Row0.x;
	i_BoneMatrix[1][2] = i_Row1.y;
	i_BoneMatrix[2][2] = i_Row2.z;

	i_BoneMatrix.toQuat(i_toQuat);
	i_toQuat.normalize();
#endif

	pBone = vectorBone[8];

	pBone->setRotationAbs(CalQuaternion(i_toQuat.x, i_toQuat.y, i_toQuat.z, i_toQuat.w));
...
#if 0
	pBone->setTranslation(CalVector(cal_vec3d.x, cal_vec3d.y, cal_vec3d.z));
	...
	pBone->setPivotTranslation(CalVector(cal_vec3d.x, cal_vec3d.y, cal_vec3d.z));
...
void unAvatar::acSetPoseNew(void)
{
	...
	if(m_BoneStructure == 0)
		...
		i_YQuat.fromAngleAxis(90, PxVec3(0,1,0));
		i_XQuat.fromAngleAxis(180, PxVec3(0, 0, 1));
		i_ZQuat.fromAngleAxis(-90, PxVec3(0, 1, 0));
...
#if 0
		cal_vec3d.x -= playerAV->Xform.Translation.x;// + cal_vec3d.y;
		cal_vec3d.y -= playerAV->Xform.Translation.y;
		cal_vec3d.z -= playerAV->Xform.Translation.z;// + cal_vec3d.y;
#endif
		...
		pBone->setTranslation(CalVector(i_vector.x, i_vector.y, i_vector.z));*/
		...
		pBone->setTranslation(CalVector(-2.711, 0.036, 3.054));
		//pBone->setTranslationAbsolute(cal_vec3d, i_avatarinverse, i_correctmatrix);
		...
		pBone->setTranslation(CalVector(17.097, 0, 0));
		//pBone->setTranslationAbsolute(cal_vec3d, i_avatarinverse, i_correctmatrix);
		...
		pBone->setTranslation(CalVector(17.065, 0, 0));
		//pBone->setTranslationAbsolute(cal_vec3d, i_avatarinverse, i_correctmatrix);
		...
		pBone->setTranslation(CalVector(16.896, 0, 0));
		//pBone->setTranslationAbsolute(cal_vec3d, i_avatarinverse, i_correctmatrix);
		...
		pBone = vectorBone[49];
		CalVector i_Leftfoot = pBone->getTranslationAbsolute();
		printf("unTrace i_Leftfoot x %f y %f z %f\n", i_Leftfoot.x, i_Leftfoot.y, i_Leftfoot.z);

		pBone = vectorBone[53];
		CalVector i_Rightfoot = pBone->getTranslationAbsolute();
...
void unAvatar::acPrintBoneAbsPos(unsigned int i_Index)
{
	...
	CalVector i_Vector = pBone->getTranslationAbsolute();
...
#include "../QAGE Include/Q-PortSHELL-VAR.h"
...
bool QpoAvatarFlags::acRender(void)
{
	//printf("acRender Avatar X %f Y %f Z %f\n", Xform.Translation.x, Xform.Translation.y, Xform.Translation.z);

	/// Temporary Calculation
	if(Avatar.Mesh->m_animtime == 0)
		{
		Avatar.Mesh->m_calModel->getMixer()->blendCycle(Avatar.Mesh->AnimNumber, 1, 0.0f);
		}

	if(Avatar.Mesh->m_oldanim != Avatar.Mesh->AnimNumber)
		{
		Avatar.Mesh->m_calModel->getMixer()->clearCycle(Avatar.Mesh->m_oldanim, 0);
		Avatar.Mesh->m_calModel->getMixer()->blendCycle(Avatar.Mesh->AnimNumber, 1, 0.0f);
		Avatar.Mesh->m_oldanim = Avatar.Mesh->AnimNumber;
		}

	//Avatar.Mesh->m_calModel->getMixer()->setTimeFactor(0.2);
	//Avatar.Mesh->onUpdate(0.5);
	//Avatar.Mesh->m_calModel->getMixer()->updateAnimation(4);

	Avatar.Mesh->m_calModel->getMixer()->setTimeFactor(0.06);
	Avatar.Mesh->m_calModel->update(0.1);

	Avatar.Mesh->m_calModel->getMixer()->updateAnimation(1);
	Avatar.Mesh->m_calModel->getMixer()->updateSkeleton();

	Avatar.Mesh->m_animtime += 1;
	...
	// GLrender Mesh
    glBindProgramARB( GL_VERTEX_PROGRAM_ARB, Avatar.Mesh->m_vertexProgramId );
    ...
    glBindBufferARB(GL_ARRAY_BUFFER_ARB, Avatar.Mesh->m_bufferObject[0]);
	glVertexAttribPointerARB(0, 3 , GL_FLOAT, false, 0, NULL);

    glBindBufferARB(GL_ARRAY_BUFFER_ARB, Avatar.Mesh->m_bufferObject[1]);
	glVertexAttribPointerARB(1, 4 , GL_FLOAT, false, 0, NULL);

	glBindBufferARB(GL_ARRAY_BUFFER_ARB, Avatar.Mesh->m_bufferObject[2]);
    glVertexAttribPointerARB(2, 3 , GL_FLOAT, false, 0, NULL);

    glBindBufferARB(GL_ARRAY_BUFFER_ARB, Avatar.Mesh->m_bufferObject[3]);

	glVertexAttribPointerARB(3, 4 , GL_FLOAT, false, 0, NULL);

    glBindBufferARB(GL_ARRAY_BUFFER_ARB, Avatar.Mesh->m_bufferObject[4]);
	glVertexAttribPointerARB(8, 2 , GL_FLOAT, false, 0, NULL);

	glBindBufferARB(GL_ELEMENT_ARRAY_BUFFER_ARB, Avatar.Mesh->m_bufferObject[5]);

	int hardwareMeshId;
	for(hardwareMeshId=0;hardwareMeshId<Avatar.Mesh->m_calHardwareModel->getHardwareMeshCount() ; hardwareMeshId++)
		{
		Avatar.Mesh->m_calHardwareModel->selectHardwareMesh(hardwareMeshId);

		unsigned char meshColor[4];	
		float materialColor[4];
		// set the material ambient color
		Avatar.Mesh->m_calHardwareModel->getAmbientColor(&meshColor[0]);
		materialColor[0] = meshColor[0] / 255.0f;  materialColor[1] = meshColor[1] / 255.0f; materialColor[2] = meshColor[2] / 255.0f; materialColor[3] = meshColor[3] / 255.0f;
		glMaterialfv(GL_FRONT, GL_AMBIENT, materialColor);
		
		// set the material diffuse color
		Avatar.Mesh->m_calHardwareModel->getDiffuseColor(&meshColor[0]);
		materialColor[0] = meshColor[0] / 255.0f;  materialColor[1] = meshColor[1] / 255.0f; materialColor[2] = meshColor[2] / 255.0f; materialColor[3] = meshColor[3] / 255.0f;
		glMaterialfv(GL_FRONT, GL_DIFFUSE, materialColor);
		
		// set the material specular color
		Avatar.Mesh->m_calHardwareModel->getSpecularColor(&meshColor[0]);
		materialColor[0] = meshColor[0] / 255.0f;  materialColor[1] = meshColor[1] / 255.0f; materialColor[2] = meshColor[2] / 255.0f; materialColor[3] = meshColor[3] / 255.0f;
		glMaterialfv(GL_FRONT, GL_SPECULAR, materialColor);
		...
		int boneId;
		for(boneId = 0; boneId < Avatar.Mesh->m_calHardwareModel->getBoneCount(); boneId++)
			{
			CalQuaternion rotationBoneSpace = Avatar.Mesh->m_calHardwareModel->getRotationBoneSpace(boneId, Avatar.Mesh->m_calModel->getSkeleton());
			CalVector translationBoneSpace = Avatar.Mesh->m_calHardwareModel->getTranslationBoneSpace(boneId, Avatar.Mesh->m_calModel->getSkeleton());
			
			translationBoneSpace.x += Xform.Translation.x;
			translationBoneSpace.y += Xform.Translation.y;
			translationBoneSpace.z += Xform.Translation.z;
...
#pragma message("Server Engine Excludes")
#if defined(WIN32)
            glBindTexture(GL_TEXTURE_2D, (GLuint)Avatar.Mesh->m_calHardwareModel->getMapUserData(0));
#endif
			}

		if(sizeof(CalIndex)==2) glDrawElements(GL_TRIANGLES, Avatar.Mesh->m_calHardwareModel->getFaceCount() * 3, GL_UNSIGNED_SHORT, (((CalIndex *)NULL)+ Avatar.Mesh->m_calHardwareModel->getStartIndex()));
		else glDrawElements(GL_TRIANGLES, Avatar.Mesh->m_calHardwareModel->getFaceCount() * 3, GL_UNSIGNED_INT, (((CalIndex *)NULL)+ Avatar.Mesh->m_calHardwareModel->getStartIndex()));
		}
