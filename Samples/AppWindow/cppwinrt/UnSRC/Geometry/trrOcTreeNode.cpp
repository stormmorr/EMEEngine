...
unTrrOcTreeNode::unTrrOcTreeNode()
{
	int i;
...
void unTrrOcTreeNode::build_node(pVertex *vert,unsigned int *facevert,int depth,int maxdepth)
{
	...
	for( i=0;i<8;i++ ) nodes[i]=new unTrrOcTreeNode;
