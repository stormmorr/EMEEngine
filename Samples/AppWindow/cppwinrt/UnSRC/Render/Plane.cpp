...
void Plane::setNormalAndPoint(Vec3 &normalb, Vec3 &pointb) {

	this->normal.copy(normalb);
	this->normal.normalize();
	d = -(this->normal.innerProduct(pointb));
}

void Plane::setCoefficients(float a, float b, float c, float db) {
