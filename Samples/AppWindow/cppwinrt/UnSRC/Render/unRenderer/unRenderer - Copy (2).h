...
public:
	...
	void draw_material_avatars(int f_Index, bool relief, MathHelper::Matrix4 f_Model, MathHelper::Matrix4 f_View, float f_X, float f_Y, float f_Z);
	...
	GLint m0AttribLocationSlot;
	GLint m1AttribLocationSlot;
	GLint m2AttribLocationSlot;
	GLint m3AttribLocationSlot;
	GLint m4AttribLocationSlot;

	GLint mModelUniformLocationSlot;
	GLint mViewUniformLocationSlot;
	GLint mProjUniformLocationSlot;
	GLint mMatricesUniformLocationSlot;
	GLint mTextureUniformLocationSlot;
	GLint mLightPosUniformLocationSlot;
	GLint mLightColorUniformLocationSlot;
	GLint mTeamUniformLocationSlot;
	GLint mAvatarTranslationUniformLocationSlot;
	...
	//AST - COPY BLOCK
	//*CGprofile aroundVertProfile;
	//*CGprogram m_vert_around_agi;
	//*CGprofile aroundFragProfile;
	//*CGprogram m_frag_around_agi;
	//*CGparameter m_around_white_out;
	//*CGparameter m_around_seedst;
	//*CGparameter m_around_sampoints;
	//*CGparameter m_around_ScreenWidth;
	//*CGparameter m_around_ScreenHeight;
	//*CGparameter m_around_ScreenDepth;
	//*CGparameter m_around_var_Final_Attenuation;
	//*CGparameter m_around_var_Radius123_Boost;
	//*CGparameter m_around_var_Cutoff_Threshold;
};
