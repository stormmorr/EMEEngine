...
public:
	...
	SDL_mutex *m_mutex_Load;
	int m_Load;

	std::string acRandPull(int i_Max);
	std::string acRandPullFloat(float i_Max);
	std::string acRandChangeFloat(float i_Input);
