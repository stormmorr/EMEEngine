...
void Q_COREFunctions::CONTROL_AvatarMuzzleFlash(int AIcounter)
	...
	if(Q_MFlash->MFlash[AIcounter].JDamageLVL > 0)
		...
		Qpo->Avatar_GetWeaponTransform(&Q_Forge->Forge[AIcounter].AV, "BIP01 R HAND", &Q_MFlash->MFlash[AIcounter].AlignMatrix);
	...
	if(Q_Forge->Forge[AIcounter].MFlash == 1 && Q_MFlash->MFlash[AIcounter].SkipFlag == 0)
		...
		if(_->NetworkOption != 1)
			{
			SCRAM = 0;
			while((SCRAM < /*Q_Forge->Forge[AIcounter].CharDATA.ItemDATA[Q_Forge->Forge[AIcounter].CharDATA.CurrWEAPON].BulletCNT*/1) && (_->NomBullet < 398))	//=-- Maximum bullet restriction
				{					
				//Initialise one BULLET
				//Trajectory
				Qpo->Avatar_GetWeaponTransform(&Q_Forge->Forge[AIcounter].AV, "BIP01 R HAND", &Q_Forge->Forge[AIcounter].TempXForm2);
				...
				Qpo->Transform_GetIn(&Q_Forge->Forge[AIcounter].TempXForm2, &Q_Bullet->Bullet[_->NomBullet].TrajVec);
				...
				if(Q_Forge->Forge[AIcounter].Soldier.JAccuracyLVL == 0)
					{
					Q_Bullet->Bullet[_->NomBullet].TrajVec.x += ((((float)rand() / 32767)-0.5)/((Q_Forge->Forge[AIcounter].CharDATA.WeaponSKILL.Accuracy/5000)*500))*((player->WeaponRecoil*200)+1)*(((5000 - Q_Forge->Forge[AIcounter].CharDATA.ItemDATA[Q_Forge->Forge[AIcounter].CharDATA.CurrWEAPON].Accuracy) / 5000) * 3);
					Q_Bullet->Bullet[_->NomBullet].TrajVec.y += ((((float)rand() / 32767)-0.5)/((Q_Forge->Forge[AIcounter].CharDATA.WeaponSKILL.Accuracy/5000)*500))*((player->WeaponRecoil*200)+1)*(((5000 - Q_Forge->Forge[AIcounter].CharDATA.ItemDATA[Q_Forge->Forge[AIcounter].CharDATA.CurrWEAPON].Accuracy) / 5000) * 3);
					Q_Bullet->Bullet[_->NomBullet].TrajVec.z += ((((float)rand() / 32767)-0.5)/((Q_Forge->Forge[AIcounter].CharDATA.WeaponSKILL.Accuracy/5000)*500))*((player->WeaponRecoil*200)+1)*(((5000 - Q_Forge->Forge[AIcounter].CharDATA.ItemDATA[Q_Forge->Forge[AIcounter].CharDATA.CurrWEAPON].Accuracy) / 5000) * 3);
					}

				if(Q_Forge->Forge[AIcounter].Soldier.JAccuracyLVL == 1)
					{
					Q_Bullet->Bullet[_->NomBullet].TrajVec.x += (((((float)rand() / 32767)-0.5)/((Q_Forge->Forge[AIcounter].CharDATA.WeaponSKILL.Accuracy/5000)*500))*((player->WeaponRecoil*200)+1)*(((5000 - Q_Forge->Forge[AIcounter].CharDATA.ItemDATA[Q_Forge->Forge[AIcounter].CharDATA.CurrWEAPON].Accuracy) / 5000) * 3) / 3);
					Q_Bullet->Bullet[_->NomBullet].TrajVec.y += (((((float)rand() / 32767)-0.5)/((Q_Forge->Forge[AIcounter].CharDATA.WeaponSKILL.Accuracy/5000)*500))*((player->WeaponRecoil*200)+1)*(((5000 - Q_Forge->Forge[AIcounter].CharDATA.ItemDATA[Q_Forge->Forge[AIcounter].CharDATA.CurrWEAPON].Accuracy) / 5000) * 3) / 3);
					Q_Bullet->Bullet[_->NomBullet].TrajVec.z += (((((float)rand() / 32767)-0.5)/((Q_Forge->Forge[AIcounter].CharDATA.WeaponSKILL.Accuracy/5000)*500))*((player->WeaponRecoil*200)+1)*(((5000 - Q_Forge->Forge[AIcounter].CharDATA.ItemDATA[Q_Forge->Forge[AIcounter].CharDATA.CurrWEAPON].Accuracy) / 5000) * 3) / 3);
					}

				if(Q_Forge->Forge[AIcounter].Soldier.JAccuracyLVL == 2)
					{
					Q_Bullet->Bullet[_->NomBullet].TrajVec.x += (((((float)rand() / 32767)-0.5)/((Q_Forge->Forge[AIcounter].CharDATA.WeaponSKILL.Accuracy/5000)*500))*((player->WeaponRecoil*200)+1)*(((5000 - Q_Forge->Forge[AIcounter].CharDATA.ItemDATA[Q_Forge->Forge[AIcounter].CharDATA.CurrWEAPON].Accuracy) / 5000) * 3) / 6);
					Q_Bullet->Bullet[_->NomBullet].TrajVec.y += (((((float)rand() / 32767)-0.5)/((Q_Forge->Forge[AIcounter].CharDATA.WeaponSKILL.Accuracy/5000)*500))*((player->WeaponRecoil*200)+1)*(((5000 - Q_Forge->Forge[AIcounter].CharDATA.ItemDATA[Q_Forge->Forge[AIcounter].CharDATA.CurrWEAPON].Accuracy) / 5000) * 3) / 6);
					Q_Bullet->Bullet[_->NomBullet].TrajVec.z += (((((float)rand() / 32767)-0.5)/((Q_Forge->Forge[AIcounter].CharDATA.WeaponSKILL.Accuracy/5000)*500))*((player->WeaponRecoil*200)+1)*(((5000 - Q_Forge->Forge[AIcounter].CharDATA.ItemDATA[Q_Forge->Forge[AIcounter].CharDATA.CurrWEAPON].Accuracy) / 5000) * 3) / 6);
					}

				if(Q_Forge->Forge[AIcounter].Soldier.JAccuracyLVL == 3)
					{
					Q_Bullet->Bullet[_->NomBullet].TrajVec.x += (((((float)rand() / 32767)-0.5)/((Q_Forge->Forge[AIcounter].CharDATA.WeaponSKILL.Accuracy/5000)*500))*((player->WeaponRecoil*200)+1)*(((5000 - Q_Forge->Forge[AIcounter].CharDATA.ItemDATA[Q_Forge->Forge[AIcounter].CharDATA.CurrWEAPON].Accuracy) / 5000) * 3) / 30);
					Q_Bullet->Bullet[_->NomBullet].TrajVec.y += (((((float)rand() / 32767)-0.5)/((Q_Forge->Forge[AIcounter].CharDATA.WeaponSKILL.Accuracy/5000)*500))*((player->WeaponRecoil*200)+1)*(((5000 - Q_Forge->Forge[AIcounter].CharDATA.ItemDATA[Q_Forge->Forge[AIcounter].CharDATA.CurrWEAPON].Accuracy) / 5000) * 3) / 30);
					Q_Bullet->Bullet[_->NomBullet].TrajVec.z += (((((float)rand() / 32767)-0.5)/((Q_Forge->Forge[AIcounter].CharDATA.WeaponSKILL.Accuracy/5000)*500))*((player->WeaponRecoil*200)+1)*(((5000 - Q_Forge->Forge[AIcounter].CharDATA.ItemDATA[Q_Forge->Forge[AIcounter].CharDATA.CurrWEAPON].Accuracy) / 5000) * 3) / 30);
					}

				Q_Bullet->Bullet[_->NomBullet].AlignMatrix = Q_Forge->Forge[AIcounter].TempXForm1;
				...
				Q_Bullet->Bullet[_->NomBullet].BulletDMG = ((float)Q_Forge->Forge[AIcounter].CharDATA.ItemDATA[Q_Forge->Forge[AIcounter].CharDATA.CurrWEAPON].Damage / 5000) * 65 * Q_Forge->Forge[AIcounter].JINK3_WeaponFactor;
				Q_Bullet->Bullet[_->NomBullet].BulletPWR = ((float)Q_Forge->Forge[AIcounter].CharDATA.ItemDATA[Q_Forge->Forge[AIcounter].CharDATA.CurrWEAPON].Power / 5000) * 65 * Q_Forge->Forge[AIcounter].JINK3_WeaponFactor;
		...
		Q_Forge->Forge[AIcounter].TempVec1 = Q_Forge->Forge[AIcounter].AV.Xform.Translation;
		Q_Forge->Forge[AIcounter].TempVec1.y += 65;
		...
		//'FIRE' SOUND
		Qpo->Sound_Play(Media->S_RifleFire[Q_Forge->Forge[AIcounter].CharDATA.ItemDATA[Q_Forge->Forge[AIcounter].CharDATA.CurrWEAPON].QAS_Fire], _->Volume, _->Pan, _->S_TimeScale, false, &Q_Forge->Forge[AIcounter].TempVec1);
		...
		Qpo->Avatar_GetWeaponTransform(&Q_Forge->Forge[AIcounter].AV, "BIP01 R HAND", &Q_Forge->Forge[AIcounter].QA_EFF_BONEMATRIX);
		...
		Qpo->Light_SetAttr(Q_MFlash->MFlash[AIcounter].Light, &Q_MFlash->MFlash[AIcounter].VecSTR, &Q_MFlash->MFlash[AIcounter].LightColor, (rand() % 50) + 150, true);
		...
		//***** MFLASH POWER SCALE ******
		Q_MFlash->MFlash[AIcounter].Scale = 20 * (Q_Bullet->Bullet[_->NomBullet-1].BulletPWR);
	...
	if(Q_Forge->Forge[AIcounter].Backpack.Draw == 1)
		...
		if(Q_Forge->Forge[AIcounter].Backpack.MatcountDir == 0)
			{
			if(Q_Forge->Forge[AIcounter].Backpack.Matcount + 2 < 12) Q_Forge->Forge[AIcounter].Backpack.Matcount += 2;	//2
			else Q_Forge->Forge[AIcounter].Backpack.MatcountDir = 1;
			}
		if(Q_Forge->Forge[AIcounter].Backpack.MatcountDir == 1)
			{
			if(Q_Forge->Forge[AIcounter].Backpack.Matcount - 2 > 0) Q_Forge->Forge[AIcounter].Backpack.Matcount -= 2;
			else	
				{
