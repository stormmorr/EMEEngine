...
#pragma message("Server engine is oblivious to rendering variables")
	...
	if(player[g_Player]->PlayerMode == 0)
		...
		//if((player[g_Player]->BFO.CharDATA[player[g_Player]->BFO.CurrCHAR].Class == 1) && ((KEY_DOWN(QIN_1) || _->mbutton[g_Player] == 1) && (player[g_Player]->Aposestate != 26 && player[g_Player]->Aposestate != 28 && player[g_Player]->Aposestate != 30)))
		...
		if(KEY_DOWN_PK_a() && (player[g_Player]->attackon == 0) /*&& !KEY_DOWN_PK(QIN_MBUTTON)*/ && 0)
			...
			if(player[g_Player]->Ninja.SpeedACT == 1)
				{
				Qpo->Vec3d_AddScaled(&playerAV[g_Player]->NewPos, player[g_Player]->ForwardSpeed*4 + 30.0f, &playerAV[g_Player]->Left, &playerAV[g_Player]->NewPos);
				Qpo->Vec3d_AddScaled(&playerAV[g_Player]->OldPos, player[g_Player]->ForwardSpeed, &playerAV[g_Player]->Left, &playerAV[g_Player]->OldPos);
				}
			else
				{
				Qpo->Vec3d_AddScaled(&playerAV[g_Player]->NewPos, player[g_Player]->ForwardSpeed + 30.0f, &playerAV[g_Player]->Left, &playerAV[g_Player]->NewPos);
				Qpo->Vec3d_AddScaled(&playerAV[g_Player]->OldPos, (player[g_Player]->ForwardSpeed / 4), &playerAV[g_Player]->Left, &playerAV[g_Player]->OldPos);
				}
		...
		if(KEY_DOWN_PK_w() /*&& !KEY_DOWN_PK(QIN_MBUTTON)*/)
			...
			if(player[g_Player]->Ninja.SpeedACT == 1)
				{
				Qpo->Vec3d_AddScaled(&playerAV[g_Player]->NewPos, player[g_Player]->ForwardSpeed, &playerAV[g_Player]->VecTo, &playerAV[g_Player]->NewPos);
				}
			else
				{
				Qpo->Vec3d_AddScaled(&playerAV[g_Player]->NewPos, player[g_Player]->ForwardSpeed, &playerAV[g_Player]->VecTo, &playerAV[g_Player]->NewPos);
