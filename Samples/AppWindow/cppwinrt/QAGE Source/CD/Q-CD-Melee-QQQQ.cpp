	...
	if(_->NetworkOption != 1)
		...
		if(Qpo->Player_Player_ExtBox_intersect(f_CountOP))
			...
			while(detcnt < 21)	//####  Second Stage - Bone Ext Bounding Box Check  ####//
				...
				if(player[g_PlayerQ]->AntiMultHits[250 + f_CountOP] < NumAttackHits && player[g_PlayerQ]->Team != player[g_Player]->Team)
					{
					...
					if(!(detcnt == 4 || detcnt == 5 || detcnt == 7 || detcnt == 13 || detcnt == 14 || detcnt == 16 && player[g_Player]->Aposestate != 21)
						...
						{
						if(Qpo->Box_DetectCollisionBetween(&_->KokBox, &_->Box) || (( player[g_PlayerQ]->attposecnt > ( stroke - 0.15 )) && ( player[g_PlayerQ]->attposecnt < ( stroke + 0.15 )) ))
							{	//COLLISION
							//### Dodge Checks
							if(!(player[g_Player]->HB_Dead == 1) && !(player[g_Player]->Block == 1 && player[g_Player]->BlockHeight == 1 && BlowHeight == 3) && !(player[g_Player]->CrouchInit == 1 && BlowHeight == 3) && !(player[g_Player]->AirBorn == 1 && BlowHeight == 1) && !(player[g_Player]->Flip == 1 && BlowHeight == 1) && !(player[g_Player]->HB_RecoverMode == 2 && (BlowHeight == 2 || BlowHeight == 3)))
								...
								player[g_PlayerQ]->attackhits++;

								//>>>---  Definate Hit On Avatar, Update Hits  ---<<<
								player[g_PlayerQ]->AntiMultHits[250 + f_CountOP]++;

								player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.ATTACKPOWER = 1.2;	//0.2
								player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.JINKATT = 0;

								//###### SWITCH OUT ATTACK SPECS
								switch(player[g_PlayerQ]->Aposestate)
									{
									case 65:	//RUSH ELBOW
										player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.ATTACKPOWER = ((player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].AttackSKILL[1].Power / 5000) * 15) + 1;
										player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.JINKATT = 1;
										break;

									case 22:	//LEAP SPIN KICK
										player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.ATTACKPOWER = ((player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].AttackSKILL[2].Power / 5000) * 15) + 1;
										player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.JINKATT = 1;
										break;

									case 31:	//RIGHT HEAVY KICK
										player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.ATTACKPOWER = ((player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].AttackSKILL[5].Power / 5000) * 15) + 1;
										player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.JINKATT = 1;
										break;

									case 58:	//SKY PUSH
										player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.ATTACKPOWER = ((player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].AttackSKILL[7].Power / 5000) * 15) + 1;
										player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.JINKATT = 1;
										break;

									case 61:	//TWIST KICK
										player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.ATTACKPOWER = ((player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].AttackSKILL[8].Power / 5000) * 15) + 1;
										player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.JINKATT = 1;
										break;

									case 32://FLAME UPPERCUT
										player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.ATTACKPOWER = ((player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].AttackSKILL[10].Power / 5000) * 15) + 1;
										player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.JINKATT = 1;
										break;

									case 35://VERY HEAVY KICK
										player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.ATTACKPOWER = ((player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].AttackSKILL[11].Power / 5000) * 15) + 1;
										player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.JINKATT = 1;
										break;

									case 76://JS RUSH UP
										player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.ATTACKPOWER = ((player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].AttackSKILL[17].Power / 5000) * 15) + 1;
										player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.JINKATT = 1;
										break;

									case 85://JS RUSH PUNCH
										player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.ATTACKPOWER = ((player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].AttackSKILL[13].Power / 5000) * 15) + 1;
										player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.JINKATT = 1;
										break;

									case 73://JS RUSH
										player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.ATTACKPOWER = ((player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].AttackSKILL[14].Power / 5000) * 15) + 1;
										player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.JINKATT = 1;
										break;

									case 64://POWER COMBO
										player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.ATTACKPOWER = ((player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].AttackSKILL[19].Power / 5000) * 15) + 1;
										player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.JINKATT = 1;
										break;

									case 75://Static Kick
										player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.ATTACKPOWER = ((player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].AttackSKILL[20].Power / 5000) * 15) + 1;
										player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.JINKATT = 1;
										break;

									case 57://JS FLAME UPPERCUT
										player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.ATTACKPOWER = ((player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].AttackSKILL[22].Power / 5000) * 15) + 1;
										player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.JINKATT = 1;
										break;

									case 25://HYPER KNEE FLEX
										player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.ATTACKPOWER = ((player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].AttackSKILL[23].Power / 5000) * 15) + 1;
										player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.JINKATT = 1;
										break;

									case 53://AIR DASH
										player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.ATTACKPOWER = ((player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].AttackSKILL[25].Power / 5000) * 15) + 1;
										player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.JINKATT = 1;
										break;

									case 56://SAKURA TRIBUTE
										player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.ATTACKPOWER = ((player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].AttackSKILL[26].Power / 5000) * 15) + 1;
										player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.JINKATT = 1;
										break;

									case 34://SPIN KICK FULL ROTATION
										player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.ATTACKPOWER = ((player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].AttackSKILL[27].Power / 5000) * 15) + 1;
										player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.JINKATT = 1;
										break;

									case 84://CYCLONE KICK
										player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.ATTACKPOWER = ((player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].AttackSKILL[16].Power / 5000) * 15) + 1;
										player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.JINKATT = 1;
										break;
									}

								player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.ATTACKPOWER *= ((float)player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.AggPower / 100);

								//##### ITEM ATTRIBUTE INCREMENT #####
								if(player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.JINKATT == 1)
									{
									player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.ATTACKPOWER += (player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.JINKINCpower / 100);
									}
								...
								if((player[g_Player]->Block == 1 && player[g_Player]->BlockHeight == BlowHeight) || (player[g_Player]->Block == 1 && player[g_Player]->BlockHeight == 3 && BlowHeight == 2))
									{
									if(player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.JINKATT == 0) player[g_Player]->BFO.CharDATA[player[g_Player]->BFO.CurrCHAR].BodySKILL.POWERBANK -= ((float)player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.AggPower + (float)player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.PhysicalStr) * (float)player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.ATTACKPOWER;
									else player[g_Player]->BFO.CharDATA[player[g_Player]->BFO.CurrCHAR].BodySKILL.POWERBANK -= (((float)player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.AggPower + (float)player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.PhysicalStr) * (float)player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.ATTACKPOWER)/2;
								...
								if(bonenum == 5 || bonenum == 4)
									{
									Q_MeleeHit->MeleeHit[_->NomMelHit].AttackSTRENGTH = ((player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.LeftArmSTRENGTH * player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.ATTACKPOWER) / 4) + 1;
									Q_MeleeHit->MeleeHit[_->NomMelHit].AttackSNAP = ((player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.LeftArmSNAP * (player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.ATTACKPOWER / 3.5)) / 6) + 1;
									}

								//Right Arm
								if(bonenum == 14 || bonenum == 13)
									{
									Q_MeleeHit->MeleeHit[_->NomMelHit].AttackSTRENGTH = ((player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.RightArmSTRENGTH * player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.ATTACKPOWER) / 4) + 1;
									Q_MeleeHit->MeleeHit[_->NomMelHit].AttackSNAP = ((player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.RightArmSNAP * (player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.ATTACKPOWER / 3.5)) / 6) + 1;
									}

								//Left Leg
								if(bonenum == 3 || bonenum == 1)
									{
									Q_MeleeHit->MeleeHit[_->NomMelHit].AttackSTRENGTH = ((player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.LeftLegSTRENGTH * player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.ATTACKPOWER) / 4) + 1;
									Q_MeleeHit->MeleeHit[_->NomMelHit].AttackSNAP = ((player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.LeftLegSNAP * (player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.ATTACKPOWER / 3.5)) / 6) + 1;
									}

								//Right Leg
								if(bonenum == 10 || bonenum == 12)
									{
									Q_MeleeHit->MeleeHit[_->NomMelHit].AttackSTRENGTH = ((player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.RightLegSTRENGTH * player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.ATTACKPOWER) / 4) + 1;
									Q_MeleeHit->MeleeHit[_->NomMelHit].AttackSNAP = ((player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.RightLegSNAP * (player[g_PlayerQ]->BFO.CharDATA[player[g_PlayerQ]->BFO.CurrCHAR].BodySKILL.ATTACKPOWER / 3.5)) / 6) + 1;
									}
								...
								if(((player[g_Player]->Block == 0 || (player[g_Player]->Block == 1 && player[g_Player]->BlockHeight != BlowHeight)) && !(player[g_Player]->Block == 1 && player[g_Player]->BlockHeight == 3 && BlowHeight == 2)) || (player[g_Player]->BFO.CharDATA[player[g_Player]->BFO.CurrCHAR].BodySKILL.POWERBANK <= 0))
									{
									if(player[g_Player]->DeflectLethal == 1 && player[g_PlayerQ]->JinkSpecialON < 1)
										{
										Q_MeleeHit->MeleeHit[_->NomMelHit].AvID = player[g_PlayerQ]->JinkSpecialON;
										Q_MeleeHit->MeleeHit[_->NomMelHit].Live = 1;
										Q_MeleeHit->MeleeHit[_->NomMelHit].INIT = 0;
										Q_MeleeHit->MeleeHit[_->NomMelHit].HitRESULT = 8;
																			//VVVVVV-----?? Change this 'impact point' to Bone hit translation maybe ??
										Q_MeleeHit->MeleeHit[_->NomMelHit].Impact = player[g_PlayerQ]->AttPos.Translation;	//Point of impact in world space
										Q_MeleeHit->MeleeHit[_->NomMelHit].Bonenum = detcnt;						//Number index of the bone hit
										Qpo->Avatar_GetBoneTransform(&playerAV[f_CountOP], BoneDef[bonenum], &Q_MeleeHit->MeleeHit[_->NomMelHit].AttboneXF);
										Q_MeleeHit->MeleeHit[_->NomMelHit].HitPowerPercent = ((player[g_PlayerQ]->attposecnt - attstt) / ( cutoff - attstt ));
										...
										if(player[g_Player]->DeflectPower == 0) player[g_PlayerQ]->HitReactScale = 0.03*((player[g_Player]->BFO.CharDATA[player[g_Player]->BFO.CurrCHAR].BodySKILL.RELQuickness*0.5)+0.5)*((1-(Q_Forge->Forge[AItempcnt].CharDATA.BodySKILL.RELRawPower/35))+0.6);
										else player[g_PlayerQ]->HitReactScale = 0.01*((player[g_Player]->BFO.CharDATA[player[g_Player]->BFO.CurrCHAR].BodySKILL.RELQuickness*0.5)+0.5)*((1-(Q_Forge->Forge[AItempcnt].CharDATA.BodySKILL.RELRawPower/35))+0.6);

										Qpo->Vec3d_Subtract(&player[g_PlayerQ]->AttPos.Translation, &player[g_PlayerQ]->OAttPos.Translation, &Q_MeleeHit->MeleeHit[_->NomMelHit].Reaction);
										...
										player[g_PlayerQ]->MoveReactVec = Q_MeleeHit->MeleeHit[_->NomMelHit].ReactionNorm;
										player[g_PlayerQ]->MoveReactVec.y = 0;
										player[g_PlayerQ]->MoveReactSpeed = 5.5;

										player[g_PlayerQ]->Aposestate = 28;
										player[g_PlayerQ]->attackon = 1;
										player[g_PlayerQ]->attposecnt = 0;

										player[g_PlayerQ]->astackcnt = 0;
										player[g_PlayerQ]->astackrun = 0;
										...
										Qpo->Avatar_GetJointTransform(playerAV[f_CountOP]->Avatar.Pose, BoneNum[detcnt], &player[g_PlayerQ]->TempXForm1);
										Qpo->Avatar_GetBoneTransform(playerAV[f_CountOP].operator ->(), BoneDef[detcnt], &player[g_PlayerQ]->TempXForm2);
										AxeStart = player[g_PlayerQ]->TempXForm2.Translation;
										Shift.x = 10;
										Shift.y = 0;
										Shift.z = 0;
										Qpo->Vec3d_Add(&player[g_PlayerQ]->TempXForm1.Translation, &Shift, &player[g_PlayerQ]->TempXForm1.Translation);
										Qpo->Avatar_SetJointTransform(playerAV[f_CountOP]->Avatar.Pose, BoneNum[detcnt], &player[g_PlayerQ]->TempXForm1);
										Qpo->Avatar_GetBoneTransform(playerAV[f_CountOP].operator ->(), BoneDef[detcnt], &player[g_PlayerQ]->TempXForm2);
										AxeEnd = player[g_PlayerQ]->TempXForm2.Translation;
										Qpo->Vec3d_Subtract(&AxeEnd, &AxeStart, &BoneMatrixX);

											//Move Joint back into place
										Qpo->Avatar_GetJointTransform(playerAV[f_CountOP]->Avatar.Pose, BoneNum[detcnt], &player[g_PlayerQ]->TempXForm1);
										Qpo->Transform_Translate(&player[g_PlayerQ]->TempXForm1,-10,0,0);
										Qpo->Avatar_SetJointTransform(playerAV[f_CountOP]->Avatar.Pose, BoneNum[detcnt], &player[g_PlayerQ]->TempXForm1);
										...
										Qpo->Vec3d_Subtract(&AxeEnd, &AxeStart, &BoneMatrixY);
											...
											//Move Joint back into place
										Qpo->Avatar_GetJointTransform(playerAV[f_CountOP]->Avatar.Pose, BoneNum[detcnt], &player[g_PlayerQ]->TempXForm1);
										Qpo->Transform_Translate(&player[g_PlayerQ]->TempXForm1,0,-10,0);
										Qpo->Avatar_SetJointTransform(playerAV[f_CountOP]->Avatar.Pose, BoneNum[detcnt], &player[g_PlayerQ]->TempXForm1);
										...
										Qpo->Vec3d_Subtract(&AxeEnd, &AxeStart, &BoneMatrixZ);
											...
											//Move Joint back into place
										Qpo->Avatar_GetJointTransform(playerAV[f_CountOP]->Avatar.Pose, BoneNum[detcnt], &player[g_PlayerQ]->TempXForm1);
										Qpo->Transform_Translate(&player[g_PlayerQ]->TempXForm1,0,0,-10);
										Qpo->Avatar_SetJointTransform(playerAV[f_CountOP]->Avatar.Pose, BoneNum[detcnt], &player[g_PlayerQ]->TempXForm1);
										...
										Qpo->Avatar_GetJointTransform(playerAV[f_CountOP]->Avatar.Pose, ParBone, &player[g_PlayerQ]->TempXForm2);
										BoneMatrix.Translation.x = player[g_PlayerQ]->TempXForm2.Translation.x;
										BoneMatrix.Translation.y = player[g_PlayerQ]->TempXForm2.Translation.y;
										BoneMatrix.Translation.z = player[g_PlayerQ]->TempXForm2.Translation.z;
										...
										Qpo->Vec3d_Add(&player[g_PlayerQ]->TempXForm1.Translation, &Q_MeleeHit->MeleeHit[_->NomMelHit].Reaction, &player[g_PlayerQ]->TempXForm1.Translation); 
										...
										Q_MeleeHit->MeleeHit[_->NomMelHit].HitPowerPercent = ((player[g_PlayerQ]->attposecnt - attstt) / ( cutoff - attstt ));
										if(((( player[g_PlayerQ]->attposecnt > ( stroke - 0.1 ) ) && ( player[g_PlayerQ]->attposecnt < ( stroke + 0.1 ))))) Q_MeleeHit->MeleeHit[_->NomMelHit].HitPowerPercent = 0.75;
										if(Q_MeleeHit->MeleeHit[_->NomMelHit].HitPowerPercent < 0.75) Q_MeleeHit->MeleeHit[_->NomMelHit].HitPowerPercent = 0.75;

											//# Deduct Health
										player[g_PlayerQ]->HB_LastAvatarHitID = AItempcnt;
										...
										if(HitType == 20)
											...
											player[g_PlayerQ]->Q_Brain.Aggression += 25;
											}
										...
										if(HitType == 13)
											...
											player[g_PlayerQ]->Q_Brain.Aggression += 10;
											}
										...
										if(HitType == 12)
											...
											player[g_PlayerQ]->Q_Brain.Aggression += 15;
											}
										...
										if(HitType == 8)
											...
											player[g_PlayerQ]->Q_Brain.Aggression += 6;
											}
										...
										if(HitType == 5)
											...
											player[g_PlayerQ]->Q_Brain.Aggression += 5;
											}
										...
										if(player[g_Player]->HB_Health <= 0)
											...
											if((playerAV[f_CountOP]atarDMGSTORE[250] * (10 * player[g_Player]->BFO.CharDATA[player[g_Player]->BFO.CurrCHAR].Level / 1000)) > 0)
												{ player[g_Player]->BFO.CharDATA[player[g_Player]->BFO.CurrCHAR][player[g_Player]->BFO.AVATARDATA[AIflag].CDATID].UnusedXP += playerAV[f_CountOP]atarDMGSTORE[250] * (10 * player[g_Player]->BFO.CharDATA[player[g_Player]->BFO.CurrCHAR].Level / 1000); }
											...
											while(SCRAM < _->NomAI)
												...
												if(Q_Forge->Forge[SCRAM].LIVE == 1)
													...
													if((Q_Forge->Forge[SCRAM].AvatarDMGSTORE[250] * (10 * player[g_Player]->BFO.CharDATA[player[g_Player]->BFO.CurrCHAR].Level / 1000)) > 0)
														{
														//### Add Experience to attacking AVATAR
														player[g_Player]->BFO.CharDATA[player[g_Player]->BFO.CurrCHAR][Q_Forge->Forge[SCRAM].CharDATA.CDataID].UnusedXP += Q_Forge->Forge[SCRAM].AvatarDMGSTORE[250] * (10 * player[g_Player]->BFO.CharDATA[player[g_Player]->BFO.CurrCHAR].Level / 1000);
										...
										if(HitType == 0)
											...
											player[g_PlayerQ]->HB_Energy += 15 * 1;
											if(player[g_PlayerQ]->HB_Energy > player[g_PlayerQ]->HB_MaxEnergy) player[g_PlayerQ]->HB_Energy = player[g_PlayerQ]->HB_MaxEnergy;
											}
										...
										if(HitType == 1)
											...
											player[g_PlayerQ]->HB_Energy += 15 * 2;
											if(player[g_PlayerQ]->HB_Energy > player[g_PlayerQ]->HB_MaxEnergy) player[g_PlayerQ]->HB_Energy = player[g_PlayerQ]->HB_MaxEnergy;
											}
										...
										if(HitType == 2)
											...
											//###Hit Reactions
											if(player[g_PlayerQ]->JinkSpecialON >= 0.5)
												{
											...
											player[g_PlayerQ]->HB_Energy += 15 * 4;
											if(player[g_PlayerQ]->HB_Energy > player[g_PlayerQ]->HB_MaxEnergy) player[g_PlayerQ]->HB_Energy = player[g_PlayerQ]->HB_MaxEnergy;
											}
										...
										if(HitType == 3)	//Standard Hit Up into Air Slightly
											...
											player[g_PlayerQ]->HB_Energy += 15 * 7;
											if(player[g_PlayerQ]->HB_Energy > player[g_PlayerQ]->HB_MaxEnergy) player[g_PlayerQ]->HB_Energy = player[g_PlayerQ]->HB_MaxEnergy;
											}
										...
										if(HitType == 10)
											...
											player[g_PlayerQ]->HB_Energy += 15 * 5;
											if(player[g_PlayerQ]->HB_Energy > player[g_PlayerQ]->HB_MaxEnergy) player[g_PlayerQ]->HB_Energy = player[g_PlayerQ]->HB_MaxEnergy;
										...
										// Assign Heavy Hits
										if(player[g_PlayerQ]->JinkSpecialON >= 1) Q_MeleeHit->MeleeHit[_->NomMelHit].HitTYPE = 20;

										//#####- Hit Reaction Motions -#####
										if(player[g_Player]->HB_DmgSTORE >= 135)
											{
											if(player[g_PlayerQ]->JinkSpecialON >= 1)
												{
												if(player[g_Player]->Aposestate != 90)
													{
													player[g_Player]->Aposestate = 90;
									...
									if(player[g_PlayerQ]->JinkSpecialON >= 1) Q_MeleeHit->MeleeHit[_->NomMelHit].HitTYPE = 2;
														...
														while(SCRAM < _->NomAI)
															...
															if(Q_Forge->Forge[SCRAM].LIVE == 1)
																...
																if((Q_Forge->Forge[SCRAM].AvatarDMGSTORE[AItempcnt] * (10 * Q_Forge->Forge[AItempcnt].CharDATA.Level / 10)) > 0)
																	{
																	//### Add Experience to attacking AVATAR
																	player[g_Player]->BFO.CharDATA[player[g_Player]->BFO.CurrCHAR][Q_Forge->Forge[SCRAM].CharDATA.CDataID].UnusedXP += Q_Forge->Forge[SCRAM].AvatarDMGSTORE[AItempcnt] * (10 * Q_Forge->Forge[AItempcnt].CharDATA.Level / 10);
									...
									if(player[g_Player]->DeflectLethal == 1 && Q_Forge->Forge[AIflag].JinkSpecialON < 1)
										...
										if(player[g_Player]->HB_Health <= 0)
											...
											if((Q_Forge->Forge[AIflag].AvatarDMGSTORE[250] * (10 * player[g_Player]->BFO.CharDATA[player[g_Player]->BFO.CurrCHAR].Level / 1000)) > 0)
												{ player[g_Player]->BFO.CharDATA[player[g_Player]->BFO.CurrCHAR][player[g_Player]->BFO.AVATARDATA[AIflag].CDATID].UnusedXP += Q_Forge->Forge[AIflag].AvatarDMGSTORE[250] * (10 * player[g_Player]->BFO.CharDATA[player[g_Player]->BFO.CurrCHAR].Level / 1000); }
												...
												if(Q_Forge->Forge[AItempcnt].DeflectLethal == 1 && Q_Forge->Forge[AIflag].JinkSpecialON < 1)
													...
													if(Q_Forge->Forge[AItempcnt].HB_Health <= 0)
														...
														if((Q_Forge->Forge[AIflag].AvatarDMGSTORE[AItempcnt] * (10 * Q_Forge->Forge[AItempcnt].CharDATA.Level / 10)) > 0)
															{ player[g_Player]->BFO.CharDATA[player[g_Player]->BFO.CurrCHAR][player[g_Player]->BFO.AVATARDATA[AIflag].CDATID].UnusedXP += Q_Forge->Forge[AIflag].AvatarDMGSTORE[AItempcnt] * (10 * Q_Forge->Forge[AItempcnt].CharDATA.Level / 10); }
