...
BiVector g_ICS_SA_Vec;

void ICS_classElement::acGen_fromBicycle(std::shared_ptr<CubeBicycle> f_Bicycle)
{
...
void ICS_classElement::acSync_fromBicycle_affinity(std::shared_ptr<CubeBicycle> f_Bicycle)
{
	m_aabb->empty();
...
void ICS_classElement::acStructuredAnalysis(void)
{
	g_ICS_SA_Vec.m_X = vec_Vertex[1]->m_X - vec_Vertex[0]->m_X;
	g_ICS_SA_Vec.m_Y = vec_Vertex[1]->m_Y - vec_Vertex[0]->m_Y;
	g_ICS_SA_Vec.m_Z = vec_Vertex[1]->m_Z - vec_Vertex[0]->m_Z;
	m_Result.m_Dist01 = g_ICS_SA_Vec.acLength();

	g_ICS_SA_Vec.m_X = vec_Vertex[2]->m_X - vec_Vertex[3]->m_X;
	g_ICS_SA_Vec.m_Y = vec_Vertex[2]->m_Y - vec_Vertex[3]->m_Y;
	g_ICS_SA_Vec.m_Z = vec_Vertex[2]->m_Z - vec_Vertex[3]->m_Z;
	m_Result.m_Dist23 = g_ICS_SA_Vec.acLength();

	g_ICS_SA_Vec.m_X = vec_Vertex[4]->m_X - vec_Vertex[5]->m_X;
	g_ICS_SA_Vec.m_Y = vec_Vertex[4]->m_Y - vec_Vertex[5]->m_Y;
	g_ICS_SA_Vec.m_Z = vec_Vertex[4]->m_Z - vec_Vertex[5]->m_Z;
	m_Result.m_Dist45 = g_ICS_SA_Vec.acLength();

	g_ICS_SA_Vec.m_X = vec_Vertex[6]->m_X - vec_Vertex[7]->m_X;
	g_ICS_SA_Vec.m_Y = vec_Vertex[6]->m_Y - vec_Vertex[7]->m_Y;
	g_ICS_SA_Vec.m_Z = vec_Vertex[6]->m_Z - vec_Vertex[7]->m_Z;
	m_Result.m_Dist67 = g_ICS_SA_Vec.acLength();

	g_ICS_SA_Vec.m_X = vec_Vertex[0]->m_X - vec_Vertex[2]->m_X;
	g_ICS_SA_Vec.m_Y = vec_Vertex[0]->m_Y - vec_Vertex[2]->m_Y;
	g_ICS_SA_Vec.m_Z = vec_Vertex[0]->m_Z - vec_Vertex[2]->m_Z;
	m_Result.m_Dist02 = g_ICS_SA_Vec.acLength();

	g_ICS_SA_Vec.m_X = vec_Vertex[1]->m_X - vec_Vertex[3]->m_X;
	g_ICS_SA_Vec.m_Y = vec_Vertex[1]->m_Y - vec_Vertex[3]->m_Y;
	g_ICS_SA_Vec.m_Z = vec_Vertex[1]->m_Z - vec_Vertex[3]->m_Z;
	m_Result.m_Dist13 = g_ICS_SA_Vec.acLength();

	g_ICS_SA_Vec.m_X = vec_Vertex[4]->m_X - vec_Vertex[6]->m_X;
	g_ICS_SA_Vec.m_Y = vec_Vertex[4]->m_Y - vec_Vertex[6]->m_Y;
	g_ICS_SA_Vec.m_Z = vec_Vertex[4]->m_Z - vec_Vertex[6]->m_Z;
	m_Result.m_Dist46 = g_ICS_SA_Vec.acLength();

	g_ICS_SA_Vec.m_X = vec_Vertex[5]->m_X - vec_Vertex[7]->m_X;
	g_ICS_SA_Vec.m_Y = vec_Vertex[5]->m_Y - vec_Vertex[7]->m_Y;
	g_ICS_SA_Vec.m_Z = vec_Vertex[5]->m_Z - vec_Vertex[7]->m_Z;
	m_Result.m_Dist57 = g_ICS_SA_Vec.acLength();

	g_ICS_SA_Vec.m_X = vec_Vertex[0]->m_X - vec_Vertex[4]->m_X;
	g_ICS_SA_Vec.m_Y = vec_Vertex[0]->m_Y - vec_Vertex[4]->m_Y;
	g_ICS_SA_Vec.m_Z = vec_Vertex[0]->m_Z - vec_Vertex[4]->m_Z;
	m_Result.m_Dist04 = g_ICS_SA_Vec.acLength();

	g_ICS_SA_Vec.m_X = vec_Vertex[1]->m_X - vec_Vertex[5]->m_X;
	g_ICS_SA_Vec.m_Y = vec_Vertex[1]->m_Y - vec_Vertex[5]->m_Y;
	g_ICS_SA_Vec.m_Z = vec_Vertex[1]->m_Z - vec_Vertex[5]->m_Z;
	m_Result.m_Dist15 = g_ICS_SA_Vec.acLength();

	g_ICS_SA_Vec.m_X = vec_Vertex[2]->m_X - vec_Vertex[6]->m_X;
	g_ICS_SA_Vec.m_Y = vec_Vertex[2]->m_Y - vec_Vertex[6]->m_Y;
	g_ICS_SA_Vec.m_Z = vec_Vertex[2]->m_Z - vec_Vertex[6]->m_Z;
	m_Result.m_Dist26 = g_ICS_SA_Vec.acLength();

	g_ICS_SA_Vec.m_X = vec_Vertex[3]->m_X - vec_Vertex[7]->m_X;
	g_ICS_SA_Vec.m_Y = vec_Vertex[3]->m_Y - vec_Vertex[7]->m_Y;
	g_ICS_SA_Vec.m_Z = vec_Vertex[3]->m_Z - vec_Vertex[7]->m_Z;
	m_Result.m_Dist37 = g_ICS_SA_Vec.acLength();
...
int ICS_classElement::acSize_Surface(void)
{
	int f_ResultCount = 0;
...
int ICS_classElement::acSize_Leg(void)
{
	int f_ResultCount = 0;
...
float ICS_classElement::acCompare(shared_ptr<ICS_classElement> f_Element, float f_QualityRank, bool f_testVolumes)
{
	float f_Mark = 0;
	...
	if(m_vec_Element.size() < f_Element->m_vec_Element.size())
		...
		if(f_testVolumes)
			...
			for(int f_Count = 0; f_Count < m_vec_Element.size(); f_Count++)
				{
				std::shared_ptr<ICS_classElement> f_TestElement = m_vec_Element[f_Count];

				if(f_Count < f_Element->m_vec_Element.size())
					{
					std::shared_ptr<ICS_classElement> f_sizeTestElement = f_Element->m_vec_Element[f_Count];
...
void ICS_classElementScript::acGen_fromElement(shared_ptr<ICS_classElement> f_Element, int f_ScriptLanguageScheme)
{
	...
	int f_WordCount = ag_ICS_takeMeasurementINTV0(f_Element, 1, 5, 1);

	std::vector<int> f_ProgOpen;

	for(int f_jet = 0; f_jet < f_WordCount; f_jet++)
		{
		int f_ComponentType = ag_ICS_takeMeasurementINTV0(f_Element, 1, 2);
		int f_BitCount = ag_ICS_takeMeasurementINTV0(f_Element, 1, 20, 2);

		ag_StatusLive(f_ref_CurrentPath, "f_Component");
		std::shared_ptr<ICS_classComponent> f_Component = std::make_shared_reflect<ICS_classComponent>(f_ComponentType);

		f_Component->m_Name = ag_NameStamp0(ag_ICS_takeMeasurement0(f_Element), f_ComponentType, f_BitCount);
			...
			if(f_XYZ == 0)
				...
				switch(f_ComponentType)
					...
					case COMPONENT_TYPE_VARINSTA:
						{
						int f_VariableType = ag_ICS_takeMeasurementINTV0(f_Element, 1, 1);
						int f_VariableState = ag_ICS_takeMeasurementINTV0(f_Element, 1, 2, 3);
					...
					case COMPONENT_TYPE_FUNCTIONCALL:
						{
						f_Component->m_vec_String.push_back(ag_ICS_takeMeasurement0(f_Element));
				...
				if(f_BitCount == COMPONENT_CNT_BASE) //2
					...
					int f_AddType = ag_ICS_takeMeasurementINTV0(f_Element, 1, 3, 2);
					...
					switch(f_AddType)
						...
						case COMPONENT_ELEMENT_TYPE_PROG:
							{
							int f_ProgType = ag_ICS_takeMeasurementINTV0(f_Element, 1, 3);

							switch(f_ProgType)
								{
								case PROG_TYPE_OPERATOR:
									{
									int f_OperatorType = ag_ICS_takeMeasurementINTV0(f_Element, 1, 1);
...
std::string ag_ICS_takeMeasurement0(shared_ptr<ICS_classElement> f_Vertex)
{
...
int ag_ICS_takeMeasurementINTV0(shared_ptr<ICS_classElement> f_Vertex, int f_StartRange, int f_EndRange, int f_WeightRangetoStart, int f_Depth) // scale resolution 1-3
{
	//query modern take measurement
...
std::string ag_ICS_NameStamp0(std::string f_Measurement, int f_Type, int f_BitCount)
{
	std::string f_Result = "";
...
std::string ag_ICS_GenerateValue0(std::string f_Measurement)
{
