...
#define VOXGRID_DIST 1280.0f

#define LOAD_DISTANCE 1 // 2 // 3
#define VIEW_DISTANCE 2 * VOXGRID_DIST // 1030.0f
#define MISS_DISTANCE 3 //* VOXGRID_DIST
...
class VoxelGridCore
	...
	public:
		VoxelGridCore()
			...
			m_blockType = new BlockType[VoxelGrid::VOXEL_GRID_SIZE_CUBED];
