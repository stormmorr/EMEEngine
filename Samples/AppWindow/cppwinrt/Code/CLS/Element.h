...
namespace ecoin
{
	...
	class classWorth : public ecom_base
	{
	public:
		classWorth()
			{
	...
	class classResult : public ecom_base_flap
	{
	public:
		classResult()
			{
	...
	class classElement : public ecom_base
	{
	public:
		classElement(shared_ptr<classElement> f_Element) : m_Type(f_Element->m_Type), m_Status(f_Element->m_Status)
			...
			make_lazy(f_ref_CurrentPath + g_ref_fun_Div + "acSetup_Corners", (void(ecom_base::*)(void))&classElement::acSetup_Corners);
#endif
			}
		...
		classElement(shared_ptr<CubeBicycle> f_Bicycle, bool f_Affinity) : m_Type(ELEM_Element), m_Status(ELEM_Element)
			{
			std::string f_ref_CurrentPath = "classElement::classElement";
	...
	class classComponent : public ecom_base
	{
	public:
	...
	class classElementScript : public ecom_base_flap
	{
	public:
	...
	class classTestSchema : public ecom_base_flap
	{
	public:
	...
	extern std::string ag_takeMeasurement0(std::shared_ptr<classElement> f_Vertex);
	extern int ag_takeMeasurementINTV0(std::shared_ptr<classElement> f_Vertex, int f_StartRange, int f_EndRange, int f_WeightRangetoStart = 0, int f_Depth = 1);
